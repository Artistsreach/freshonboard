    ...
    server: {
      ...
      proxy: {
        "/gemini-live": {
          ...
          changeOrigin: true,
          rewrite: (path2) => path2.replace(/^\/gemini-live/, "")
        }
      }
    },
    resolve: {
