  ...
  return (
    <section className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center justify-center bg-[var(--theme-primary-10)] p-3 mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {itemsToDisplay.map((item, index) => (
            <motion.div
              ...
              className="bg-card p-6 shadow-lg text-center border border-border/50 hover:shadow-2xl transition-shadow"
            >
