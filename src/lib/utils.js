...
console.log("[utils.js] VITE_PEXELS_API_KEY loaded:", PEXELS_API_KEY_FROM_ENV ? "Exists" : "MISSING");
...
console.log("[utils.js] VITE_GEMINI_API_KEY loaded:", GEMINI_API_KEY_FROM_ENV ? "Exists" : "MISSING");
...
export const generateImageWithGemini = async (prompt) => {
  ...
  try {
    ...
    console.log(`[utils.js/generateImageWithGemini] Calling Gemini with prompt: "${prompt}"`);
    ...
    if (response.candidates && response.candidates.length > 0 && response.candidates[0].content && response.candidates[0].content.parts) {
      for (const part of response.candidates[0].content.parts) {
        ...
        if (part.inlineData && part.inlineData.data) {
          ...
          console.log(`[utils.js/generateImageWithGemini] Image generated. MimeType: ${imageMimeType}`);
    ...
    console.error("[utils.js/generateImageWithGemini] Error generating image with Gemini:", error);
